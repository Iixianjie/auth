...
export interface Callback {
    (pass: boolean, rejects: ValidMeta[]): void;
}
export declare type Subscribe = (listener: () => void) => () => void;
/** 验证结束的Promise */
export declare type PromiseBack = {
    pass: boolean;
    rejects: ValidMeta[];
};
/** 用于验证的auth keys */
export declare type AuthKeys<V> = Array<keyof V | Array<keyof V>>;
export interface Auth<D, V> {
     ...
     * @return - resolve callback同样参数对象的Promise，和callback二选一
     * */
    auth(authKeys: AuthKeys<V>, extra: any, callback?: Callback): Promise<PromiseBack>;
}
